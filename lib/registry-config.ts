...
export const orbRegistry: OrbRegistryEntry[] = [
  {
    ...
    componentName: "Shdr01",
    fileName: "shdr-01.tsx",
    dependencies: []
  },
  {
    slug: "shdr-02",
    ...
    componentName: "Shdr02",
    fileName: "shdr-02.tsx",
    dependencies: []
  },
  {
    slug: "shdr-03",
    ...
    componentName: "Shdr03",
    fileName: "shdr-03.tsx",
    dependencies: []
  },
  {
    slug: "shdr-04",
    ...
    componentName: "Shdr04",
    fileName: "shdr-04.tsx",
    dependencies: []
  },
  {
    slug: "shdr-05",
    ...
    componentName: "Shdr05",
    fileName: "shdr-05.tsx",
    dependencies: []
  },
  {
    slug: "shdr-06",
    ...
    componentName: "Shdr06",
    fileName: "shdr-06.tsx",
    dependencies: []
  },
  {
    slug: "shdr-07",
    ...
    componentName: "Shdr07",
    fileName: "shdr-07.tsx",
    dependencies: []
  },
  {
    slug: "shdr-08",
    ...
    componentName: "Shdr08",
    fileName: "shdr-08.tsx",
    dependencies: []
  },
  {
    slug: "shdr-09",
    ...
    componentName: "Shdr09",
    fileName: "shdr-09.tsx",
    dependencies: []
  },
  {
    slug: "shdr-10",
    ...
    componentName: "Shdr10",
    fileName: "shdr-10.tsx",
    dependencies: []
  },
  {
    slug: "shdr-11",
    ...
    componentName: "Shdr11",
    fileName: "shdr-11.tsx",
    dependencies: []
  },
  {
    slug: "shdr-12",
    title: "SHDR-12",
    description:
      "A ball built from glossy toy bricks: a DDA march through a staggered brickwork lattice — layers alternate their bond direction and every course staggers by a hashed offset, so seams never stack — with studs embossed on every upward face, joints drawn only on true brick boundaries, five tunable plastic colours slidable from per-brick confetti to big moulded patches, and a white Blinn sheen. Thinking blinks bricks out of the outer courses and back, the ball visibly rebuilding itself; speaking snaps it whole, fast and glossy.",
    componentName: "Shdr12",
    fileName: "shdr-12.tsx",
    dependencies: []
  },
  {
    slug: "shdr-13",
    title: "SHDR-13",
    description:
      "A plasma globe: pink-to-violet lightning filaments crawling from a hot nucleus to the glass, built as the joint zero set of two animated fields over the direction sphere — so every streamer is genuinely radial, stays rooted while its far end wanders, and flares where it lands on the shell. More streamers grow in as the agent gets louder.",
    componentName: "Shdr13",
    fileName: "shdr-13.tsx",
    dependencies: []
  },
  {
    slug: "shdr-14",
    title: "SHDR-14",
    description:
      "A lit plasma dome quantized to chunky two-tone pixels: lambert light, drifting fbm plasma and a fresnel rim collapse into one luminance, and an 8x8 ordered Bayer matrix — generated procedurally, since GLSL ES 1.0 has neither array initializers nor bitwise ops — snaps it onto a short ink-to-paper tone ladder. Two steps is the classic 1-bit look.",
    componentName: "Shdr14",
    fileName: "shdr-14.tsx",
    dependencies: []
  },
  {
    slug: "shdr-15",
    ...
    componentName: "Shdr15",
    fileName: "shdr-15.tsx",
    dependencies: []
  },
  {
    slug: "shdr-16",
    title: "SHDR-16",
    description:
      "Sunlight through water: a caustic net crawling over the ball. Two crossed families of crest lines, their crossings added back so the foci burn hottest, read through a three-octave sine fold that refracts the net rather than scrolling it, and mapped triplanar so the ball can turn forever with no pole and no seam. The net is sampled at three moments, one per channel, so edges fringe into colour only where they move. A surge on an integrated clock lifts gain and ripple depth together. Thinking runs fast, thin and cold; speaking heaves in long gold breaths on wine-dark water.",
    componentName: "Shdr16",
    fileName: "shdr-16.tsx",
    dependencies: []
  },
  {
    slug: "shdr-17",
    title: "SHDR-17",
    description:
      "A grainy, many-coloured storm raging on the ball: two-level domain-warped fbm on a stereographic wrap of a rotating dome, jovian band shear flowing latitude rings past each other, a four-stop palette with an iridescent cosine rainbow multiplied over it, hashed lightning strikes that strobe while the agent speaks, and two taps of animated white noise — one dithering the gradient into speckle, one as plain film grain.",
    componentName: "Shdr17",
    fileName: "shdr-17.tsx",
    dependencies: []
  },
  {
    slug: "shdr-18",
    ...
    componentName: "Shdr18",
    fileName: "shdr-18.tsx",
    dependencies: []
  },
  {
    slug: "shdr-19",
    ...
    componentName: "Shdr19",
    fileName: "shdr-19.tsx",
    dependencies: []
  },
  {
    slug: "shdr-20",
    ...
    componentName: "Shdr20",
    fileName: "shdr-20.tsx",
    dependencies: []
  },
  {
    slug: "shdr-21",
    ...
    componentName: "Shdr21",
    fileName: "shdr-21.tsx",
    dependencies: []
  },
  {
    slug: "shdr-22",
    ...
    componentName: "Shdr22",
    fileName: "shdr-22.tsx",
    dependencies: []
  },
  {
    slug: "shdr-23",
    title: "SHDR-23",
    description:
      "An ASCII glyph matrix in CRT green, wrapped on the ball: a resolution-relative grid of woven dash characters whose lit-row count quantizes a streaming fbm field — exactly how ASCII art shades — with blocky dropouts eaten out of the matrix on a coarser super-grid, a stereographic wrap that rolls the weave around the sphere, and a phosphor ramp from deep green to hot glow.",
    componentName: "Shdr23",
    fileName: "shdr-23.tsx",
    dependencies: []
  },
  {
    slug: "shdr-24",
    title: "SHDR-24",
    description:
      "A Minecraft Earth: a voxel planet marched block by block, its ground a perfect sphere with oceans flush on it and mountains, forests and deserts rising above. An integrated season clock weathers the whole world through five climates — lush, cherry grove (flat pink blossom puffs over vivid meadows), ice (packed-ice spires, glacier patches, frozen seas), mesa (big terraced terracotta towers, red sand, cacti) and desert; the deep stone runs clustered ore veins whose texture flecks glow, and caves warm toward a molten core that blazes as the agent speaks. Thinking streams the terrain and races the seasons, so continents morph like chunks loading.",
    componentName: "Shdr24",
    fileName: "shdr-24.tsx",
    dependencies: []
  },
  {
    slug: "shdr-25",
    ...
    componentName: "Shdr25",
    fileName: "shdr-25.tsx",
    dependencies: []
  },
  {
    slug: "shdr-26",
    ...
    componentName: "Shdr26",
    fileName: "shdr-26.tsx",
    dependencies: []
  },
  {
    slug: "shdr-27",
    title: "SHDR-27",
    description:
      "A weather-radar mosaic on the ball: the sphere is twisted by hashed vortices, each a rotation about the axis through it with a Gaussian falloff, and two scales of 3D noise are read through the twist and multiplied, so storm systems wind into spirals with concentric legend rings and drift on the clock. The dome is cut into a pixel grid that never rolls, each cell centre is inverse-projected onto the sphere and read once, so every dot is one flat colour from a seven-class radar legend — grey, blue, cyan, green, red, yellow, magenta — with the class boundaries dithered by a per-cell hash and the quiet areas thinned to a sparse twinkling scatter on cream paper.",
    componentName: "Shdr27",
    fileName: "shdr-27.tsx",
    dependencies: []
  },
  {
    slug: "shdr-28",
    ...
    componentName: "Shdr28",
    fileName: "shdr-28.tsx",
    dependencies: []
  },
  {
    slug: "shdr-29",
    title: "SHDR-29",
    description:
      "An LED tile wall lighting up in flowing blobs, wrapped on the ball: every cell is a bevelled tile that keeps a faint dark presence when unlit, a streaming fbm field decides which tiles light through the stereographic wrap of a rotating dome, and a per-tile hash promotes a reshuffling scattering of lit tiles to fully saturated confetti hues.",
    componentName: "Shdr29",
    fileName: "shdr-29.tsx",
    dependencies: []
  },
  {
    slug: "shdr-30",
    title: "SHDR-30",
    description:
      "A flower meadow folding into itself, falling forever toward a blue vanishing point: the log of the Chebyshev norm turns nested square frames into a continuous index, so every fragment maps back into one base picture and that picture contains itself. Sky, cloud, canopy, water and hashed flowers are painted in base-frame coordinates so the same weather repeats at every scale, the wall smear falls out of sampling the land noise on distance-around-the-frame against frame index, and aerial haze keyed to the screen radius makes the middle read as far away rather than merely small.",
    componentName: "Shdr30",
    fileName: "shdr-30.tsx",
    dependencies: []
  },
  {
    slug: "shdr-31",
    ...
    componentName: "Shdr31",
    fileName: "shdr-31.tsx",
    dependencies: []
  },
  {
    slug: "shdr-32",
    title: "SHDR-32",
    description:
      "A galaxy marched as a volume of gas and dust inside the ball: a flared exponential disc under a Gaussian bulge, modulated by log-spiral arms and broken into filaments by four octaves of feedback-curl turbulence, accumulated front-to-back with a blue-weighted extinction so thick gas reddens what lies behind it — the dust lanes fall out of the physics. Hashed stars sit at each ray's exact hit with the galactic plane, veiled by the dust in front of them. The disc tips between states: a calm three-quarter spiral at rest, a face-on boiling whirlpool while searching, a face-on flaring spiral breathing on the beat while answering.",
    componentName: "Shdr32",
    fileName: "shdr-32.tsx",
    dependencies: []
  },
  {
    slug: "shdr-33",
    title: "SHDR-33",
    description:
      "A thermal image put through a cheap colour print, wrapped on the ball: rounded-box heat sources drift across the plane as plateaus with exponential skirts, their sum saturates to white where they overlap and is quantized into the nested rectangular contours of a false-colour ramp, then the palette is separated into cyan, magenta and yellow and laid down as three misregistered screens of square dots on grainy paper — violet where cyan crosses magenta, orange where magenta crosses yellow, paper showing through the hot cores.",
    componentName: "Shdr33",
    fileName: "shdr-33.tsx",
    dependencies: []
  }
];
